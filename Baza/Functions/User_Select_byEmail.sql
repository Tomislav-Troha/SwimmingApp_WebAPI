...
RETURNS TABLE (id int, name varchar, surname varchar, email varchar, username varchar, password bytea, addres varchar, salt bytea, RoleID int, roleName varchar, roleDesc varchar)
AS
$$
